...
class AffiliateWP_Store_Credit_WooCommerce extends AffiliateWP_Store_Credit_Base {
	...
	public function init() {
		...
		add_action( 'render_block_woocommerce/checkout-express-payment-block', [ $this, 'action_add_checkout_notice_to_checkout_block' ], 10, 2 ); // WooCommerce 6+.
	}
	...
	public function action_add_checkout_notice_to_checkout_block( string $content, array $block ) : string {
		...
		$this->action_add_checkout_notice();
	...
	public function action_add_checkout_notice() {
		...
		$coupon_applied = $this->check_for_coupon( WC()->cart->get_applied_coupons() ?? [] );

		// If the user has a credit balance and has not already generated and applied a coupon code.
